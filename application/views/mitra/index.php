                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        if ($mtr['status_mitra'] == 1) { ?>
                                                                            <a href="<?= base_url(); ?>mitra/block/<?= $mtr['id_mitra'] ?>"><button class="btn btn-dark text-red mr-2">Block</button></a>
                                                                        <?php } else { ?>
                                                                            <a href="<?= base_url(); ?>mitra/unblock/<?= $mtr['id_mitra'] ?>"><button class="btn btn-success text-red mr-2">Unblock</button></a>
                                                                        <?php } ?>
