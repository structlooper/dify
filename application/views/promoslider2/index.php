...
<div class="content-wrapper">
  <div class="card">
    <div class="card-body">
      <div>
        <a class="btn btn-info" href="<?= base_url(); ?>promoslider2/tambah"><i class="mdi mdi-plus-circle-outline"></i>Add Promo Slider</a>
      </div>
      <br>
              ...
              <tbody>
                ...
                foreach ($promo as $pr) { ?>
                  <tr>
                    ...
                    <td>
                      <a href="<?= base_url(); ?>promoslider2/ubah/<?= $pr['id']; ?>">
                        <button class="btn btn-primary">Edit</button></a>
                      <a href="<?= base_url(); ?>promoslider2/hapus/<?= $pr['id']; ?>" onclick="return confirm ('are you sure?')">
