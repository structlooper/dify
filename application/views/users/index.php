                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="<?= base_url(); ?>users/detail/<?= $us['id'] ?>">
                                                                        <button class="btn btn-outline-primary mr-3 text-dark">View</button>
                                                                    </a>
                                                                    <?php if ($us['status'] == 0) { ?>
                                                                        <a href="<?= base_url(); ?>users/userunblock/<?= $us['id'] ?>">
                                                                            <button class="btn btn-outline-success text-white mr-2">Unblock</button>
                                                                        </a>
                                                                    <?php } else { ?>
                                                                        <a href="<?= base_url(); ?>users/userblock/<?= $us['id'] ?>">
                                                                            <button class="btn btn-outline-primary text-dark mr-2">Block</button>
                                                                        </a>
                                                                    <?php } ?>
                                                                    <a href="<?= base_url(); ?>users/hapususers/<?= $us['id'] ?>">
                                                                        <button onclick="return confirm ('Are You Sure?')" class="btn btn-outline-primary text-dark mr-2">Delete</button>
                                                                    </a>
                                                                </td>
                                                            <?php $i++;
                                                        } ?>
