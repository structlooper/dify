                    ...
                    <div class="row w-100">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-left p-5">
                                ...
                                <?php endif; ?>
                                <h2>Login</h2>
                                <h4 class="font-weight-light">Hello! Welcome to dify </h4>
                                ...
                                <div class="mt-5">
                                    ...
                                    <br>
                                    <span class="text-muted d-block text-center  justify-center ">Copyright © 2020 <a class="text-success" href="#">Dify</a>. All rights reserved.</span>
                                </div>
                                <?= form_close(); ?>
                            </div>
                        </div>
