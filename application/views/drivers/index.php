                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        if ($drv['status'] != 0) {
                                                                            ...
                                                                            if ($drv['status'] != 3) { ?>
                                                                                <a href="<?= base_url(); ?>driver/block/<?= $drv['id'] ?>"><button class="btn btn-dark text-red mr-2">Block</button></a>
                                                                            <?php } else { ?>
                                                                                <a href="<?= base_url(); ?>driver/unblock/<?= $drv['id'] ?>"><button class="btn btn-success text-red mr-2">Unblock</button></a>
                                                                        <?php }
                                                                        } ?>
                                                                        <a href="<?= base_url(); ?>driver/hapus/<?= $drv['id'] ?>">
                                                                            <button onclick="return confirm ('Are You Sure?')" class="btn btn-danger text-red mr-2">Delete</button>
                                                                        </a>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <a href="<?= base_url(); ?>driver/block/<?= $drv['id'] ?>">
                                                                                <button class="btn btn-success text-red mr-2">Block</button>
                                                                            </a>
                                                                            <a href="<?= base_url(); ?>driver/hapus/<?= $drv['id'] ?>">
                                                                                <button class="btn btn-danger text-red mr-2">Delete</button>
                                                                            </a>
                                                                        </td>
                                                                    </tr>
                                                        <?php $i++;
                                                            ...
                                                            if ($drv['status_job'] == 4 or $drv['status_job'] == 5 and $drv['status'] != 0 and $drv['status'] != 3) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href="<?= base_url(); ?>driver/block/<?= $drv['id'] ?>">
                                                                            <button class="btn btn-dark text-red mr-2">Block</button>
                                                                        </a>
                                                                        <a href="<?= base_url(); ?>driver/hapus/<?= $drv['id'] ?>">
                                                                            <button class="btn btn-danger text-red mr-2">Delete</button>
                                                                        </a>
