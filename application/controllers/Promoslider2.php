...
class Promoslider2 extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('promoslider2_model', 'promo');
    ...
    public function index()
    {
        ...
        $this->load->view('promoslider2/index', $data);
    ...
    public function ubah($id)
    {
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->load->view('includes/header');
            $this->load->view('promoslider2/editslider' . $id, $data);
            $this->load->view('includes/footer');
        }
    }
}
