...
print_r($request['status']);exit;
    ...
    function add_address_Post(){
        ...
        $dec_data = json_decode($data);
            ...
            'address_title'      => $dec_data->address_title,
            'created_at'     => date('Y-m-d H:i:s'),
           
            
        );
      
        $result = $this->Pelanggan_model->insert_user_address($user_address);
    ...
    function get_address_Post(){
        ...
        $result = $this->Pelanggan_model->get_user_address($dec_data->user_id);
