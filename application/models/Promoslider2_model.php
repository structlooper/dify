...
class promoslider2_model extends CI_model
{
    public function getAllpromo()
    {
        ...
        return  $this->db->get('promosi2')->result_array();
    }

    public function getpromobyid($id)
    {
        return $this->db->get_where('promosi2', ['id' => $id])->row_array();
    }

    public function tambahdatapromo($data)
    {
        return $this->db->insert('promosi2', $data);
    }

    public function hapuspromobyId($id)
    {
        $this->db->where('id', $id);
        $this->db->delete('promosi2');
    }
    ...
    public function ubahdatapromo($data)
    {
        ...
        return $this->db->update('promosi2', $data);
    }
}
